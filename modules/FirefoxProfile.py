...
def FFdriver(download_dir=None):
    option = Options()
    option.add_argument("--headless") # set headless
    option.set_preference("headless",True)
    option.set_preference('intl.accept_languages', 'en-GB, en-US, en') # set preferred languages
    # set auto-download without prompt
